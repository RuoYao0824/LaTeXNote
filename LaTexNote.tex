...
\end{figure} \\
\end{verbatim}
其中[H]表示使圖片不隨文字移動，\verb|\centering|表示將圖片置中， \\
\verb|\includegraphics[width=0.3\textwidth]{圖檔名}|表示匯入圖片並將其以0.3的倍率顯示。
\section{插入連結}
...
\end{math}
\section{成果展示}
這篇文件，存於GitHub內:\url{https://github.com/RuoYao0824/LaTeXNote.git} \\
